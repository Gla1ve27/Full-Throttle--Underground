...
namespace UnityStandardAssets.Water
{
    ...
    public class Water : MonoBehaviour
    {
        ...
        {
#if UNITY_PIPELINE_HDRP || UNITY_PIPELINE_URP || true
            return; // Legacy Water scripts use Camera.Render() which is explicitly forbidden in HDRP and spams "Unable to add Renderer to the Scene after Culling"
#endif
