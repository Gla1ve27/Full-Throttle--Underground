...
Offset[_OffsetFactor] ,[_OffsetUnit]
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord41 = packedInput.ase_texcoord5.zw * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode47 = tex2D( _Albedo, texCoord41 );
				float temp_output_65_0 = ( packedInput.ase_color.a / _Threshold );
				float4 lerpResult80 = lerp( ( tex2DNode53 * _Color0 ) , ( tex2DNode47 * _Color ) , temp_output_65_0);
				
				float2 texCoord60 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float3 unpack68 = UnpackNormalScale( tex2D( _BumpMap, texCoord60 ), _BumpScale1 );
				unpack68.z = lerp( 1, unpack68.z, saturate(_BumpScale1) );
				float2 texCoord50 = packedInput.ase_texcoord5.zw * float2( 1,1 ) + float2( 0,0 );
				float3 unpack63 = UnpackNormalScale( tex2D( _BumpMap2, texCoord50 ), _BumpScale2 );
				unpack63.z = lerp( 1, unpack63.z, saturate(_BumpScale2) );
				float3 lerpResult75 = lerp( unpack68 , unpack63 , temp_output_65_0);
				
				float2 uv_MetallicGlossMap = packedInput.ase_texcoord5.xy * _MetallicGlossMap_ST.xy + _MetallicGlossMap_ST.zw;
				float4 tex2DNode59 = tex2D( _MetallicGlossMap, uv_MetallicGlossMap );
				float2 texCoord42 = packedInput.ase_texcoord5.zw * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode55 = tex2D( _MetallicGlossMap2, texCoord42 );
				float lerpResult77 = lerp( ( tex2DNode59.r * _MainMetallicPower3 ) , ( tex2DNode55.r * _MainMetallicPower4 ) , temp_output_65_0);
				
				float lerpResult78 = lerp( ( tex2DNode59.a * _MainSmoothnessPower3 ) , ( tex2DNode55.a * _MainSmoothnessPower4 ) , temp_output_65_0);
				
				float lerpResult72 = lerp( ( tex2DNode59.g * _OcclusionStrength3 ) , ( tex2DNode55.g * _OcclusionStrength4 ) , temp_output_65_0);
				
				float lerpResult81 = lerp( ( tex2DNode53.a * _Color0.a ) , ( tex2DNode47.a * _Color.a ) , temp_output_65_0);
				
				surfaceDescription.BaseColor = lerpResult80.rgb;
				surfaceDescription.Normal = lerpResult75;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = lerpResult77;
				...
				surfaceDescription.Smoothness = lerpResult78;
				surfaceDescription.Occlusion = lerpResult72;
				surfaceDescription.Alpha = lerpResult81;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 tex2DNode53 = tex2D( _MainTex, uv_MainTex );
				float2 texCoord41 = packedInput.ase_texcoord2.zw * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode47 = tex2D( _Albedo, texCoord41 );
				float temp_output_65_0 = ( packedInput.ase_color.a / _Threshold );
				float4 lerpResult80 = lerp( ( tex2DNode53 * _Color0 ) , ( tex2DNode47 * _Color ) , temp_output_65_0);
				
				float2 texCoord60 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float3 unpack68 = UnpackNormalScale( tex2D( _BumpMap, texCoord60 ), _BumpScale1 );
				unpack68.z = lerp( 1, unpack68.z, saturate(_BumpScale1) );
				float2 texCoord50 = packedInput.ase_texcoord2.zw * float2( 1,1 ) + float2( 0,0 );
				float3 unpack63 = UnpackNormalScale( tex2D( _BumpMap2, texCoord50 ), _BumpScale2 );
				unpack63.z = lerp( 1, unpack63.z, saturate(_BumpScale2) );
				float3 lerpResult75 = lerp( unpack68 , unpack63 , temp_output_65_0);
				...
				float4 tex2DNode59 = tex2D( _MetallicGlossMap, uv_MetallicGlossMap );
				float2 texCoord42 = packedInput.ase_texcoord2.zw * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode55 = tex2D( _MetallicGlossMap2, texCoord42 );
				float lerpResult77 = lerp( ( tex2DNode59.r * _MainMetallicPower3 ) , ( tex2DNode55.r * _MainMetallicPower4 ) , temp_output_65_0);
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float4 tex2DNode53 = tex2D( _MainTex, uv_MainTex );
				float2 texCoord41 = packedInput.ase_texcoord1.zw * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode47 = tex2D( _Albedo, texCoord41 );
				float temp_output_65_0 = ( packedInput.ase_color.a / _Threshold );
				float lerpResult81 = lerp( ( tex2DNode53.a * _Color0.a ) , ( tex2DNode47.a * _Color.a ) , temp_output_65_0);
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float3 unpack68 = UnpackNormalScale( tex2D( _BumpMap, texCoord60 ), _BumpScale1 );
				unpack68.z = lerp( 1, unpack68.z, saturate(_BumpScale1) );
				float2 texCoord50 = packedInput.ase_texcoord3.zw * float2( 1,1 ) + float2( 0,0 );
				float3 unpack63 = UnpackNormalScale( tex2D( _BumpMap2, texCoord50 ), _BumpScale2 );
				unpack63.z = lerp( 1, unpack63.z, saturate(_BumpScale2) );
				float temp_output_65_0 = ( packedInput.ase_color.a / _Threshold );
				float3 lerpResult75 = lerp( unpack68 , unpack63 , temp_output_65_0);
				...
				float4 tex2DNode59 = tex2D( _MetallicGlossMap, uv_MetallicGlossMap );
				float2 texCoord42 = packedInput.ase_texcoord3.zw * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode55 = tex2D( _MetallicGlossMap2, texCoord42 );
				float lerpResult78 = lerp( ( tex2DNode59.a * _MainSmoothnessPower3 ) , ( tex2DNode55.a * _MainSmoothnessPower4 ) , temp_output_65_0);
				
				float2 uv_MainTex = packedInput.ase_texcoord3.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float4 tex2DNode53 = tex2D( _MainTex, uv_MainTex );
				float2 texCoord41 = packedInput.ase_texcoord3.zw * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode47 = tex2D( _Albedo, texCoord41 );
				float lerpResult81 = lerp( ( tex2DNode53.a * _Color0.a ) , ( tex2DNode47.a * _Color.a ) , temp_output_65_0);
		...
		Pass
		{
						...
						)
			{
				...
				float4 tex2DNode53 = tex2D( _MainTex, uv_MainTex );
				float2 texCoord41 = packedInput.ase_texcoord7.zw * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode47 = tex2D( _Albedo, texCoord41 );
				float temp_output_65_0 = ( packedInput.ase_color.a / _Threshold );
				float4 lerpResult80 = lerp( ( tex2DNode53 * _Color0 ) , ( tex2DNode47 * _Color ) , temp_output_65_0);
				...
				float3 unpack68 = UnpackNormalScale( tex2D( _BumpMap, texCoord60 ), _BumpScale1 );
				unpack68.z = lerp( 1, unpack68.z, saturate(_BumpScale1) );
				float2 texCoord50 = packedInput.ase_texcoord7.zw * float2( 1,1 ) + float2( 0,0 );
				float3 unpack63 = UnpackNormalScale( tex2D( _BumpMap2, texCoord50 ), _BumpScale2 );
				unpack63.z = lerp( 1, unpack63.z, saturate(_BumpScale2) );
				float3 lerpResult75 = lerp( unpack68 , unpack63 , temp_output_65_0);
				...
				float4 tex2DNode59 = tex2D( _MetallicGlossMap, uv_MetallicGlossMap );
				float2 texCoord42 = packedInput.ase_texcoord7.zw * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode55 = tex2D( _MetallicGlossMap2, texCoord42 );
				float lerpResult77 = lerp( ( tex2DNode59.r * _MainMetallicPower3 ) , ( tex2DNode55.r * _MainMetallicPower4 ) , temp_output_65_0);
