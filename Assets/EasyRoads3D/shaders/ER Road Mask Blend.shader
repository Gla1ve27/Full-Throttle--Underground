	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 tex2DNode67 = tex2D( _Mask, texCoord41 );
				float4 lerpResult73 = lerp( ( tex2DNode42 * _Color ) , ( tex2D( _Albedo, uv_Albedo ) * _Color0 ) , tex2DNode67.g);
				
				float2 texCoord51 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float3 unpack65 = UnpackNormalScale( tex2D( _BumpMap, texCoord51 ), _BumpScale );
				unpack65.z = lerp( 1, unpack65.z, saturate(_BumpScale) );
				float2 texCoord57 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float3 unpack66 = UnpackNormalScale( tex2D( _DetailNormalMapScale, texCoord57 ), _BumpScale1 );
				unpack66.z = lerp( 1, unpack66.z, saturate(_BumpScale1) );
				
				float2 uv_Metallic = packedInput.ase_texcoord5.xy * _Metallic_ST.xy + _Metallic_ST.zw;
				float4 tex2DNode43 = tex2D( _Metallic, uv_Metallic );
				float2 uv_MetallicGlossMap2 = packedInput.ase_texcoord5.xy * _MetallicGlossMap2_ST.xy + _MetallicGlossMap2_ST.zw;
				float4 tex2DNode46 = tex2D( _MetallicGlossMap2, uv_MetallicGlossMap2 );
				float lerpResult77 = lerp( ( tex2DNode43.r * _MetallicPower ) , ( tex2DNode46.r * _Float0 ) , tex2DNode67.g);
				
				float lerpResult71 = lerp( ( tex2DNode43.a * _SmoothnessPower ) , ( tex2DNode46.a * _Float1 ) , tex2DNode67.g);
				
				float lerpResult69 = lerp( ( tex2DNode43.g * _OcclusionStrength ) , ( tex2DNode46.g * _AmbientOcclusionPower ) , tex2DNode67.g);
				
				surfaceDescription.BaseColor = lerpResult73.rgb;
				surfaceDescription.Normal = BlendNormal( unpack65 , unpack66 );
				...
				surfaceDescription.Smoothness = lerpResult71;
				surfaceDescription.Occlusion = lerpResult69;
				surfaceDescription.Alpha = tex2DNode42.a;
