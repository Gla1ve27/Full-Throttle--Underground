...
Offset[_OffsetFactor] ,[_OffsetUnit]
		...
		Pass
		{
						...
						)
			{
				...
				float4 lerpResult71 = lerp( ( tex2D( _MainTex, uv_MainTex ) * _Color ) , ( tex2D( _Albedo, texCoord41 ) * _Color0 ) , packedInput.ase_color.a);
				
				float2 texCoord54 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float3 unpack62 = UnpackNormalScale( tex2D( _BumpMap, texCoord54 ), _BumpScale );
				unpack62.z = lerp( 1, unpack62.z, saturate(_BumpScale) );
				float3 unpack59 = UnpackNormalScale( tex2D( _DetailNormalMapScale, texCoord41 ), _BumpScale1 );
				unpack59.z = lerp( 1, unpack59.z, saturate(_BumpScale1) );
				float3 lerpResult73 = lerp( unpack62 , unpack59 , packedInput.ase_color.a);
				
				float2 uv_Metallic = packedInput.ase_texcoord5.xy * _Metallic_ST.xy + _Metallic_ST.zw;
				float4 tex2DNode56 = tex2D( _Metallic, uv_Metallic );
				float4 tex2DNode44 = tex2D( _MetallicGlossMap2, texCoord41 );
				float lerpResult68 = lerp( ( tex2DNode56.r * _MetallicPower ) , ( tex2DNode44.r * _Float0 ) , packedInput.ase_color.a);
				
				float lerpResult74 = lerp( ( tex2DNode56.a * _SmoothnessPower ) , ( tex2DNode44.a * _Float1 ) , packedInput.ase_color.a);
				
				float lerpResult77 = lerp( ( tex2DNode56.g * _OcclusionStrength ) , ( tex2DNode44.g * _AmbientOcclusionPower ) , packedInput.ase_color.a);
				
				surfaceDescription.BaseColor = lerpResult71.rgb;
				surfaceDescription.Normal = lerpResult73;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = lerpResult68;
				...
				surfaceDescription.Occlusion = lerpResult77;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 texCoord54 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float3 unpack62 = UnpackNormalScale( tex2D( _BumpMap, texCoord54 ), _BumpScale );
				unpack62.z = lerp( 1, unpack62.z, saturate(_BumpScale) );
				float3 unpack59 = UnpackNormalScale( tex2D( _DetailNormalMapScale, texCoord41 ), _BumpScale1 );
				unpack59.z = lerp( 1, unpack59.z, saturate(_BumpScale1) );
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 texCoord54 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float3 unpack62 = UnpackNormalScale( tex2D( _BumpMap, texCoord54 ), _BumpScale );
				unpack62.z = lerp( 1, unpack62.z, saturate(_BumpScale) );
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord54 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float3 unpack62 = UnpackNormalScale( tex2D( _BumpMap, texCoord54 ), _BumpScale );
				unpack62.z = lerp( 1, unpack62.z, saturate(_BumpScale) );
				float3 unpack59 = UnpackNormalScale( tex2D( _DetailNormalMapScale, texCoord41 ), _BumpScale1 );
				unpack59.z = lerp( 1, unpack59.z, saturate(_BumpScale1) );
