	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord43 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float3 unpack56 = UnpackNormalScale( tex2D( _BumpMap, texCoord43 ), _BumpScale );
				unpack56.z = lerp( 1, unpack56.z, saturate(_BumpScale) );
				...
				surfaceDescription.Normal = unpack56;
				...
				surfaceDescription.Alpha = ( tex2DNode42.a * _Color.a );
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 texCoord43 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float3 unpack56 = UnpackNormalScale( tex2D( _BumpMap, texCoord43 ), _BumpScale );
				unpack56.z = lerp( 1, unpack56.z, saturate(_BumpScale) );
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord43 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float3 unpack56 = UnpackNormalScale( tex2D( _BumpMap, texCoord43 ), _BumpScale );
				unpack56.z = lerp( 1, unpack56.z, saturate(_BumpScale) );
